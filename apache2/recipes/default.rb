...
display_title do
  title 'Configuration of apache2'
end
...
display_title do
  title 'Disable http2 module'
end
execute "disable http2 module" do
  command "sed -e '/LoadModule http2_module/ s/^#*/#/g' -i /etc/httpd/conf.modules.d/00-base.conf"
