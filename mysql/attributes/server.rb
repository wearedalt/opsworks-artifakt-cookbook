...
default[:mysql][:tunable][:explicit_defaults_for_timestamp] = 'ON'

default[:mysql][:tunable][:slow_query_log]    = File.join(node[:mysql][:logdir], 'mysql-slow.log')
default[:mysql][:tunable][:long_query_time]   = 2

default[:mysql][:clients] = []

# default charset and collation of future database create
default[:mysql][:charset] = 'utf8'
default[:mysql][:collation] = 'utf8_general_ci'
