...
when 'rhel', 'fedora'
  ...
  pid = "/var/run/php-fpm/php-fpm-#{node[:app][:language_long]}.pid"
else
  user = 'www-data'
  group = 'www-data'
...
default['php-fpm']['package_name'] = "php#{node[:app][:language]}-fpm"
default['php-fpm']['service_name'] = 'php-fpm'

default['php-fpm']['docker_dir'] = '/srv/www/php'

include_attribute "php-fpm::php-packages"
